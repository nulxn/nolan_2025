...
<img src="/nolan_2025/images/one/cropped.png" alt="cropped" />
...
| --- | --- | --- |
| **2025 FRQ 2** | Focused on **class design**—specifically mapping out properties before implementation. I also learned to account for edge cases (like zero values) to maintain stable state logic. | [View Blog](https://www.google.com/search?q=%7B%7Bsite.baseurl%7D%7D/posts/frq-2025-2/) |
| **2016 FRQ 3** | Mastered **2D array manipulation**, specifically initializing empty structures and populating them dynamically while preventing `IndexOutOfBounds` errors. | [View Blog](https://www.google.com/search?q=%7B%7Bsite.baseurl%7D%7D/posts/frq-2016-3/) |
| **2024 FRQ 1** | Refined my **simulation logic** by validating conditions prior to loop entry. I also strengthened my use of `Math.random()` for generating precise probability ranges. | [View Blog](https://www.google.com/search?q=%7B%7Bsite.baseurl%7D%7D/posts/frq-2024-1/) |
| **2019 FRQ 4** | Developed a strategy for **complex problem decomposition**, such as calculating aggregate column data before updating individual element statuses. | [View Blog](https://www.google.com/search?q=%7B%7Bsite.baseurl%7D%7D/posts/frq-2019-4/) |
